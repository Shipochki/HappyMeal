        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    DeliveryCosts = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Restaurateurs_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinMoneyForOrder = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Restaurants_Restaurateurs_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CartId", "Email", "FirstName", "IsActive", "LastName", "PhoneNumber" },
                values: new object[] { 1, 1, "nikola.stefanov@gmail.com", "Nikola", true, "Stefanov", "0895555123" });

            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "Name", "UserId" },
                values: new object[] { 1, "NikolaOwner", 1 });

            migrationBuilder.InsertData(
                table: "Carts",
                columns: new[] { "Id", "DeliveryCosts", "Subtotal", "UserId" },
                values: new object[] { 1, 0m, 0m, 1 });
